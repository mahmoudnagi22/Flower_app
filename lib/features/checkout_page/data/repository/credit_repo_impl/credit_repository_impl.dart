...
class CreditOrderRepoImpl implements CreditOrderRepository {
  ...
  @override
  Future<ApiResult<CreditOrderResponseEntity>> placeCreditOrder(RequestShippingBody request) async{
   // CreditOrderRequestDto orderRequest = CreditOrderRequestDto.fromEntity(request);
    return await creditCheckoutServiceContract.performCreditCheckout(request);
  }
